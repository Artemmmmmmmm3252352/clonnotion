      ...
      <div className="w-full max-w-md">
        <div className="bg-white rounded-2xl shadow-xl p-8">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-[#37352f] mb-2">Вход в NoteZero</h1>
            <p className="text-[#9b9a97]">Введите свои данные для входа</p>
          </div>
          ...
          <div className="mt-6 text-center">
            <p className="text-sm text-[#9b9a97]">
              Нет аккаунта?{' '}
              <Link to="/signup" className="text-[#2383e2] hover:underline font-medium">
                Зарегистрироваться
              </Link>
            </p>
          </div>
